 ...
 {name: "Höhle", akt: "2", Aktion: "Wenn man die Fackel besitzt, kann man von dieser Höhle direkt zu einer anderen Höhlenkarte ziehen.",ver: "true", warn:"Fackel" , bgc:"blue"},
 {name: "Lager", akt: "2", Aktion: "Ihr findet das versteckte Lager des Jägers.",hor: "true", bgc:"green"},
 ...
 {name: "Jäger", akt: "2", Aktion: "Der Großwildjäger Stoephasius klaut dir alle Artefakte und bringt sie zu seinem Lager. Mit der Pistole kannst du sie ihm dort abnehmen.",warn:"Pistole", bgc:"orange", win:"Fluss", bgcwin:"blue",task: true},
  {name: "Idol", akt: "2", Aktion: "Mit dem Idol kannst du die Ureinwohner verjagen und an Ihnen vorbeilaufen.", imgclass:"symbol", task: true},
 {name: "Dynamit", akt: "2", Aktion: "Du findest einen versteckten Vorrat an Dynamit und kannst damit einen Felsen sprengen. Lege dazu das Dynamit von einem Nachbarfeld aus ohne Wand dazwischen auf den Felsen.", imgclass:"symbol",task: true},
 {name: "Überfall", order: "4", akt: "2", color : "H",Aktion: "Jack kommt ins Nachtlager zurück und Jane ist verschwunden. Er findet Spuren eines Kampfes und Pfeile der Ureinwohner.", warn:"Voodoopuppe", win:"Jane2", bgcwin:"green", task: true},
